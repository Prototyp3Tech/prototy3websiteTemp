...
const HeroSection: React.FC<HeroSectionProps> = ({  
  ...
  return (
    <section className="text-gray-800 sm:pt-20 pt-0 min-h-screen relative overflow-hidden" id="hero">
      <div className="mx-auto px-3 px-5 pt-5 max-w-[80vw] md:ml-[20vw]">
          ...
          <div className="flex justify-center align-top w-auto max-w-none max-h-[60vh] breakpointFix lg:max-h-[55vh] lg:justify-start order-1 lg:order-1 z-10">
            <div className="transWhite p-4 sm:p-6 md:p-8 lg:p-12 rounded-xl sm:rounded-2xl shadow-2xl">
              <div className="flex items-start">
                <span className="text-orange-500 font-extrabold text-xl lg:text-5xl mr-4">{'{'}</span>
                <div className="flex-1">
                  <h1 className="textFix text-6xl font-bold leading-tight text-gray-700" style={{color: '#1F2937'}}>
                   Zero Experience? 
                  </h1> 
                  <h1 className="textFix text-6xl font-bold mb-4 sm:mb-6 leading-tight text-gray-700 -mt-2" style={{color: '#1F2937'}}>
                   Perfect. Let's Build.
                  </h1>
